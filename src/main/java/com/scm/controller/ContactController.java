...
public class ContactController {
    ...
    public String addContactView(Model model) {
        ...
        // contactForm.setName("Dipak");
        // contactForm.setEmail("Dipak3@gmail.com");
        // contactForm.setPhoneNumber("6370940888");
        // contactForm.setAddress("Kolkata");
        // contactForm.setDescription("Hello good Morning");
        // contactForm.setFavorite(true);
        // contactForm.setWebsiteLink("www.google.com");
    ...
    public String saveContact(@Valid @ModelAttribute ContactForm contactForm, BindingResult result,
        ...
        // @Valid check karne ke badh agar sahi me valid hai to hume Binding result
        // milega

        // Process the from data

        // validate form data
        if (result.hasErrors()) { // agar kuch error hoga to addcontact page mein hi redirect kar denge
    ...
    public String searchHandler(
        ...
        // jo parameter receive kar rahe ho view page se wahi rakhna
    ...
    // agar Requestmapping ka variable aur method ka variable same hoga to
    // @Pathvariable("") is bracket ke andar pathvariable ka name likh ne ki jarurat
    // nhi hai
    public String deleteContact(@PathVariable("contactId") String Id, HttpSession session) {
        contactService.delete(Id);
        logger.info("Contact deleted with id {}", Id);

        // delete message pass through session
    ...
    public String updateContact(@PathVariable("contactId") String contactId, @Valid @ModelAttribute ContactForm contactForm, BindingResult bindingResult, Model model ) {
        ...
        if (contactForm.getContactImage() != null && !contactForm.getContactImage().isEmpty()) {
            logger.info("Image is not empty");
            String fileName = UUID.randomUUID().toString();
